...
from server.resources.mappings import HOST_API_CHOICES, HOST_API_CHOICES_SPACE


class ResourceApiHost(Resource):
    ...
    def get(self):
        ...
        if "space" in query_string:
            payload = HOST_API_CHOICES_SPACE
        else:
            payload = HOST_API_CHOICES
