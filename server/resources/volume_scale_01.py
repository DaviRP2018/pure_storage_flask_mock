...
class ResourceApiVolumeScaleDc3Edpure01Scale01(Resource):
    ...
    def get(self):
        ...
        if "space" in query_string:
            payload = VOL_SCALE_01_API_CHOICES_SPACE
        elif "snap" in query_string:
            payload = VOL_SCALE_01_API_CHOICES_SNAP
        elif query_string.get("action") == "monitor" and query_string.get("historical") == "1h":
            payload = VOL_SCALE_01_API_CHOICES_ACTION
        else:
            payload = []
